...
export function CtaSection() {
  return (
    <section aria-labelledby="cta-title" className="px-4 pb-20 sm:px-6 sm:pb-28">
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-8 rounded-2xl border border-rule bg-surface p-8 shadow-[0_12px_32px_-16px_var(--shadow)] sm:p-12 lg:flex-row lg:items-center">
        <div>
